...
public class RegisterPage {
	...
	public boolean userRegisteration(String firstName, String lastName,
		...
		eleUtil.doSendKeys1(this.lastName, lastName);
		
		eleUtil.doSendKeys1(this.email, StringUtil.getRandomEmailId());
		
		eleUtil.doSendKeys1(this.telephone, telephone);
		eleUtil.doSendKeys1(this.password, password);
		eleUtil.doSendKeys1(this.confirmpassword, password);
